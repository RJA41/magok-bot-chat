...
theme: /
    ...
    state: createUser
        ...
        buttons:
            "Назад" -> /Start
            "Звонок менеджеру"
        intent: /Назад || toState = "/Start"
        event: noMatch || toState = "./"

    state: CreateOrderStep1
        a: Для оформления заказа необходимо зарегистрироваться на сайте &#129488; || htmlEnabled = true, html = "Для оформления заказа необходимо зарегистрироваться на сайте &#129488;\n"
        buttons:
    ...
    state: createOrder
        ...
        buttons:
            ...
            "Звонок менеджера"
        intent: /Звонок || toState = "./"
        intent: /Вернуться || toState = "/mainMenu"
        event: noMatch || toState = "./"
    ...
    state: timeplan
        a: МАГ Полковая 🧭
                ...
                воскресенье 09:00 - 18:00 || htmlEnabled = true, html = "<b>МАГ Полковая&nbsp;</b>🧭<br><br>понедельник-пятница <i>09:00 - 19:00</i><br>суббота <i>09:00 - 18:00</i><br>воскресенье <i>09:00 - 18:00</i><br><br><b>МАГ Сельскохозяйственная&nbsp;</b>🧭<br><br>понедельник-пятница <i>09:00 - 18:00\n</i><br>суббота <i>10:00 - 16:00\n</i><br>воскресенье - <i>выходной</i><br><br><b>МАГ Адмирала Макарова&nbsp;</b>🧭<br><br>пн-пт <i>09:00 - 19:00\n</i><br>суббота <i>09:00 до 18:00\n</i><br>воскресенье <i>09:00 - 18:00</i><br>"
        buttons:
            "Назад" -> /Start
            "Звонок менеджера"
        intent: /Назад || toState = "/Start"
    ...
    state: deliveryTab
        a: Про условия доставки можно узнать здесь 🚐
            https://magok.ru/info/clients/#StoimostDostavki || htmlEnabled = true, html = "Про условия доставки можно узнать здесь&nbsp;🚐<br><a href="https://magok.ru/info/clients/#StoimostDostavki" target="_blank">https://magok.ru/info/clients/#StoimostDostavki</a><br>"
        buttons:
            "Назад" -> /Start
            "Звонок менеджера"
        intent: /Назад || toState = "/Start"
    ...
    state: payment
        a: Оплатить заказ можно по расчетному счету (для юридических лиц) или по ссылке для оплаты. Счет и реквизиты нашей компании вложены в письмо, которое придет Вам после оформления заказа.
            О условиях работы можно прочитать здесь
            https://magok.ru/info/clients/
             || htmlEnabled = true, html = "Оплатить заказ можно по расчетному счету (для юридических лиц) или по ссылке для оплаты. Счет и реквизиты нашей компании вложены в письмо, которое придет Вам после оформления заказа.<br>О условиях работы можно прочитать здесь<br><a href="https://magok.ru/info/clients/" target="_blank">https://magok.ru/info/clients/</a><br>"
        buttons:
            "Назад" -> /Start
            "Звонок менеджера"
        intent: /Назад || toState = "/Start"
    ...
    state: vozvrat
        a: Порядок оформления возврата описан здесь
                https://magok.ru/info/clients
                Нам жаль, что мы разочаровали Вас😭  || htmlEnabled = true, html = "Порядок оформления возврата описан здесь<br><a href="https://magok.ru/info/clients/" target="_blank">https://magok.ru/info/clients</a><br>Нам жаль, что мы разочаровали Вас😭&nbsp;<br>"
        buttons:
            "Назад" -> /Start
            "Звонок менеджера"
        intent: /Назад || toState = "/Start"
